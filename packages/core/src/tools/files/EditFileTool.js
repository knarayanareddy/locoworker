...
export const EditFileTool = {
    name: "Edit",
    description: "Surgical string replacement in a file. Fails if old_string is not unique unless replace_all is true. Preserves indentation and line endings.",
    ...
    async execute(input, ctx) {
        ...
        if (occurrences > 1 && !input.replace_all) {
            return err(`old_string occurs ${occurrences} times. Provide more context or set replace_all=true.`);
        }
