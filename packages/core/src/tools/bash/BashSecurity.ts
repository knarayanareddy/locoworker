...
export type SecurityResult = { safe: true } | { safe: false; reason: string };

const HARD_BLOCKLIST: RegExp[] = [
...
export function checkBashCommand(command: string): SecurityResult {
