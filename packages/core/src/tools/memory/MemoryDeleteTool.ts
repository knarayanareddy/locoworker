...
export function makeMemoryDeleteTool(memory: MemorySystem): ToolDefinition<DeleteInput> {
  return {
    name: "MemoryDelete",
    description:
      "Delete a stored memory by type and id. Use this when a memory is contradicted, no longer applicable, or was saved in error.",
