...
export function microCompact(content: string, opts: MicroCompactOptions = {}): string {
...
export function microCompactToolResult(result: string, opts?: MicroCompactOptions): string {
